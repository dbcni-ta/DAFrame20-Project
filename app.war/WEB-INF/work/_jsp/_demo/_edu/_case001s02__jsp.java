...
public class _case001s02__jsp extends com.cni.fw.arch.ArchJsp implements com.caucho.jsp.CauchoPage
{
    ...
    throws Throwable
  {
    ...
    out.print(( output.get("name") ));
    out.write(_jsp_string3, 0, _jsp_string3.length);
    out.print(( output.get("age") ));
    out.write(_jsp_string4, 0, _jsp_string4.length);
    out.print(( output.get("city") ));
    out.write(_jsp_string5, 0, _jsp_string5.length);
    out.print(( position.get(IntMaker.make(output.get("position"))) ));
    out.write(_jsp_string6, 0, _jsp_string6.length);
    out.print(( corpInfo.get("corpName") ));
    out.write(_jsp_string4, 0, _jsp_string4.length);
    out.print(( corpInfo.get("corpCity") ));
    out.write(_jsp_string7, 0, _jsp_string7.length);
    
	for (int i=0;i<position.size();i++) {

    out.write(_jsp_string8, 0, _jsp_string8.length);
    out.print(( position.get(i) ));
    ...
    out.print(( team.get("name") ));
    out.write(_jsp_string12, 0, _jsp_string12.length);
    out.print(( position.get(IntMaker.make(team.get("position"))) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("demo/edu/case001s02.jsp"), 4582384236713100878L, false);
    _caucho_depends.add(depend);
