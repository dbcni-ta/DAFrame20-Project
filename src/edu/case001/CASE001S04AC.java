...
public class CASE001S04AC extends NormalTxService {
    ...
    protected void process(CauseDTO input, EffectDTO output) throws FrameException, ServiceException, SQLException {
    	...
    	// MASTER 설정
    	// seongj : request param은 모두 input master에 들어가있음
        ...
        Nexter mtoKeys = input.getMtoSet().getNexter();
        while (mtoKeys.hasNext()) {
        	String key = mtoKeys.next();
        	MTO mto = input.getMTO(key);
        	
        	output.putMTO(key, mto);
